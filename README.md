...
Core Java开始学习，前边还都是基础看得很快

稍微体验了一下图灵完备，感觉学习计组玩这个游戏比上课强

# 2024.3.16

Core Java学到了P203,很多东西都提前学过感觉还好

也补充学会了一些新的概念，希望早日完全学完这本书吧。

# 2024.3.18

hexo网页若使用主题next则不能嵌入bilibili视频代码块,否则会被拦截且显示空白

hexo主页搭建好了并且上传了两篇文章,开启了一些插件

关于和标签两个页面还没做，有待后续完善

已经部署到github

由于next主题中markdown渲染器自带序号,我需要将序号删除后再做上传处理

应该能选择是否开启,明天研究一下

# 2024.3.19

hexo的里的Markdown基础教程彻底修改好了,这标题号还是不能乱用

写完了计组，算法设计与分析，数据库专题训练三门作业，我感觉快要死了:sweat:

# 2024.3.20

这汇编语言作业是人类能写的了的？
博客更新了关于页，标签页，分类页，开启评论功能
...
Core Java学完了第五章,第六章学到了函数式接口

# 2024.3.23

修改了汇编作业,真是太难了...

Core Java学到了代理,不得不说Java细节还是挺多的,lambda表达式更花哨的用法也掌握了一些
...
优化了博客字体，更纱黑体谷歌字体居然没有

# 2024.3.27

这JavaScript语法真随便吧？this想指那指那，各种莫名其妙的不规范用法，好像搞笑一样的定义和各种为了补救而诞生的函数:slightly_smiling_face:
